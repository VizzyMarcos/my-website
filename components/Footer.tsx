  ...
  return (
    <footer className="mt-16 border-t border-slate-200/80 bg-white/85 backdrop-blur-xl">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 md:grid-cols-[1.6fr_0.9fr]">
        ...
        <div>
          <h3 className="mb-4 text-sm font-extrabold uppercase tracking-[0.2em] text-slate-500">Support</h3>
          <div className="space-y-3 text-sm font-medium">
            <Link href="/track-order" className="flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-slate-700 transition hover:border-blue-400 hover:bg-blue-50 hover:text-blue-600">
              <span>Track Order</span>
            </Link>
            <Link href="/contact" className="flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-slate-700 transition hover:border-blue-400 hover:bg-blue-50 hover:text-blue-600">
